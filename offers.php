...
<head>
  ...
  <title>vvo infotech llp-Offers</title>
      ...
      <div class="container">
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="assets/img/portfolio/offer1.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4></h4>
              <p>OFFERS</p>
              <a href="assets/img/portfolio/offer1.jpg" data-gall="portfolioGallery" class="venobox preview-link" title=""><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="assets/img/portfolio/SW-offer2.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4></h4>
              <p>Software</p>
              <a href="assets/img/portfolio/SW-offer2.jpg" data-gall="portfolioGallery" class="venobox preview-link" title=""><i class="bx bx-plus"></i></a>
              <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="assets/img/portfolio/HW-offer3.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4></h4>
              <p>Hardware</p>
              <a href="assets/img/portfolio/HW-offer3.jpg" data-gall="portfolioGallery" class="venobox preview-link" title=""><i class="bx bx-plus"></i></a>
              <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="assets/img/portfolio/SW-offer3.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4></h4>
              <p>Software</p>
              <a href="assets/img/portfolio/SW-offer3.png" data-gall="portfolioGallery" class="venobox preview-link" title=""><i class="bx bx-plus"></i></a>
              <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="assets/img/portfolio/HW-offer1.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4></h4>
              <p>Hardware</p>
              <a href="assets/img/portfolio/HW-offer1.jpg" data-gall="portfolioGallery" class="venobox preview-link" title="Card 1"><i class="bx bx-plus"></i></a>
              <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="assets/img/portfolio/HW-offer3.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4></h4>
              <p>Hardware</p>
              <a href="assets/img/portfolio/HW-offer3.png" data-gall="portfolioGallery" class="venobox preview-link" title=""><i class="bx bx-plus"></i></a>
              <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
